...
description: >-
  ...
  and get one graded report. It fans out to amber, ami, bart, catskin, chakra,
  ferret hunt, fract, isopod, lwoodz, scrawny, tempcheq, traci, vamos,
  viva-palestina, and wilder (jeenome is
...
verification), which is not a health defect signal either way. It's
`NotApplicable` when no source file could be lowered into its process IR.
